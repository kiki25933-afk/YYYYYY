...
<html lang="ko">
<head>
    <!-- 모바일 화면 비율 고정 및 자동 확대 방지 (짤림 해결 요소 1) -->
    <meta charset="UTF-8">
    ...
    <style>
        * {
        ...
        /* [요시 알 배경 스타일 추가 - 기존 body 속성 유지하며 배경만 변경] */
        html, body {
            background-color: #ffffff !important;
            color: #000000 !important;
            /* 요시 알 패턴 구현 */
            background-image: 
                radial-gradient(#4CAF50 20%, transparent 20%),
                radial-gradient(#4CAF50 20%, transparent 20%) !important;
        ...
        body.dark-mode {
            ...
            background-image: 
                radial-gradient(#2ecc71 15%, transparent 15%),
                radial-gradient(#2ecc71 15%, transparent 15%) !important;
        ...
        @media (max-width: 768px) {
            /* 1. 명함 카드 화면 밖으로 짤림 방지 (화면 비율 맞춤) */
            .card-3d {
                width: 85vw !important;
                height: 53vw !important; /* 1.6:1 비율 유지 */
                max-width: 320px !important;
                max-height: 200px !important;
                touch-action: none; /* 드래그 시 화면 스크롤 방지 */
            }

            /* 2. 통계 차트(캔버스) 사이즈 화면에 맞춤 (짤림 원인 1) */
            canvas {
                max-width: 100% !important;
                height: auto !important;
            }

            /* 3. 소셜 링크 카드 사이즈 및 1열 정렬 (짤림 원인 2) */
            #allLinksContainer {
                grid-template-columns: 1fr !important;
            }
            
            /* 4. 과도한 패딩으로 인한 컨텐츠 찌그러짐/짤림 해결 */
            .about-content,
            .social-card,
            .social-info-card,
            .qr-container,
            ...
            /* 5. 텍스트 및 버튼 크기 모바일 맞춤 */
            .portfolio-section h2, .about-content h2, #displayCompanyTitle {
            ...
            /* 6. 기존 모바일 패널 및 포트폴리오 슬라이더 설정 */
            .qr-customize { grid-template-columns: 1fr; }
            .edit-panel { width: 100% !important; right: -100% !important; padding: 20px !important; }
            .edit-panel.open { right: 0 !important; }
            .stats-grid { grid-template-columns: 1fr; }
            
            .portfolio-slider { max-width: 90%; height: 400px !important; }
            .portfolio-slide { width: 100% !important; left: 0 !important; height: 350px !important; }
